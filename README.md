...
- popups de aviso da extensão acompanham o tema claro/escuro da Zweb, usam abertura/fechamento mais suaves, seguem o modal nativo do sistema e permitem fechamento por `X` e `Cancelar`
